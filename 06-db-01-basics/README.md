...
PACELC-теорема
PACELC-теорема расширяет CAP-теорему и добавляет еще один аспект — поведение системы в нормальных условиях, когда разделений сети нет.
В данном случае система в нормальных условиях и при разделении сети не обеспечивает ни одно из свойств.
По PACELC - не подходит
```
