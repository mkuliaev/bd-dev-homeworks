...
PACELC-теорема
При подключении латентность над согласованностью, а при разделении сети  — доступность.
PA/EL
...
PACELC-теорема
При подключении (нормальных условиях ) подходит согласованностью или латентностью, а при разделении сети — доступность.
PA/EC
PA/EL
